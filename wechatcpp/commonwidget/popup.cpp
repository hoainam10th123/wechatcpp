...
void Popup::show()
{
    ...
    setGeometry(primaryScreen->availableGeometry().width() - 36 - width() + primaryScreen->availableGeometry().x(),
                primaryScreen->availableGeometry().height() - 36 - height() + primaryScreen->availableGeometry().y(),
                width(),
                height());
    QWidget::show();
